...
import { IWorld, WorldQueryFragment } from "solecs/interfaces/IWorld.sol";
import { QueryFragment } from "solecs/interfaces/Query.sol";
import { IUint256Component } from "solecs/interfaces/IUint256Component.sol";
import { Uint256Component } from "solecs/components/Uint256Component.sol";
import { addressToEntity, entityToAddress, getIdByAddress, getAddressById, getComponentById } from "solecs/utils.sol";
import { componentsComponentId, systemsComponentId } from "solecs/constants.sol";
import { RegisterSystem, ID as registerSystemId, RegisterType } from "solecs/systems/RegisterSystem.sol";
...
contract BareWorld is IWorld {
  ...
  function registerComponentValueSet(
    ...
    require(msg.sender == component, "Only this component can call.");
  ...
  function getNumEntities() public pure returns (uint256) {
   ...
   */
  function hasEntity(uint256) public pure returns (bool) {
    revert("Not implemented");
  }
   ...
   */
  function getUniqueEntityId() public pure returns (uint256) {
    revert("Not implemented");
  }
}
